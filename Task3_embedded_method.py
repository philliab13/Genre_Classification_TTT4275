...
def best_split_for_feature(X, y, feature):
    ...
    for threshold in values:
        ...
        weighted_impurity = (len(y_left) * left_impurity +
                             len(y_right) * right_impurity) / len(y)
...
# Run Selection
best_4th_feature = embedded_feature_selection(
    X, y, exclude_features=predefined, top_k=1)
...
train_X, train_y, test_X, test_y = fdtu.create_data(
    feat_dict, selected_features, "GenreID", 0.8)
